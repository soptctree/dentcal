...
menu = st.sidebar.radio("Navegación", ["Agenda Diaria Sillon", "Agendar Cita Dental", "Pacientes y Expedientes", "Configuración"])
...
# --- MÓDULO 3: PACIENTES Y EXPEDIENTES ---
    ...
    tab1, tab2, tab3 = st.tabs(["Registrar Paciente", "Historial de Tratamientos", "Nueva Evolución Clínica"])
